...
function Terms() {
    return (
      <div className="terms_cont">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to The Rubik's.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to The Rubik's.</p>
        </li>
        <li>
